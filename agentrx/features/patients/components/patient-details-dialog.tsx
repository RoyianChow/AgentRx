  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent
          className="max-h-[92vh] overflow-hidden rounded-3xl border-slate-200 p-0 shadow-2xl sm:max-w-5xl"
          aria-describedby={descriptionId}
        >
          <div className="border-b bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 px-6 py-5 text-white">
            <DialogHeader>
